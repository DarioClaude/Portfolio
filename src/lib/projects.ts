...
export const projects: Project[] = [
  ...
  },
  {
    ...
    year: 2023,
    gallery: [
      { src: "", alt: "Rugby 1", orientation: "landscape" },
      { src: "", alt: "Rugby 2", orientation: "portrait" },
      { src: "", alt: "Rugby 3", orientation: "landscape" },
      { src: "", alt: "Rugby 4", orientation: "portrait" },
      { src: "", alt: "Rugby 5", orientation: "landscape" },
      { src: "", alt: "Rugby 6", orientation: "landscape" },
      { src: "", alt: "Rugby 7", orientation: "portrait" },
      { src: "", alt: "Rugby 8", orientation: "landscape" },
      { src: "", alt: "Rugby 9", orientation: "portrait" },
      { src: "", alt: "Rugby 10", orientation: "landscape" },
      { src: "", alt: "Rugby 11", orientation: "landscape" },
      { src: "", alt: "Rugby 12", orientation: "portrait" },
    ],
  },
  {
    id: 4,
