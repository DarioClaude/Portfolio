...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "about.heading": "Salut, c'est Dario, photographe français avec 4+ ans d'expérience à capturer les émotions brutes et les histoires visuelles minimalistes. Ma passion réside dans la création de moments à la fois visuellement marquants et profondément significatifs.",
    ...
    "about.location.line": "Basé à Bordeaux, France",
  ...
  en: {
    ...
    "about.heading": "Hi, I'm Dario, a French photographer with 4+ years of experience capturing raw emotions and minimalist visual stories. My passion lies in creating moments that are not only visually striking but also genuinely meaningful and lasting.",
    "about.stats.years.value": "4+",
    ...
    "about.location.line": "Based in Bordeaux, FR",
  ...
  es: {
    ...
    "about.heading": "Hola, soy Dario, fotógrafo francés con 4+ años de experiencia capturando emociones puras y narrativas visuales minimalistas. Mi pasión es crear momentos visualmente impactantes y profundamente significativos que perduren.",
    "about.stats.years.value": "4+",
    ...
    "about.location.line": "Con base en Bordeaux, FR",
