...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "privacy.footer": "Pour toute question relative à cette politique de confidentialité, vous pouvez contacter Dario Tonini à l'adresse toninidario@yahoo.fr.",
  },
  ...
  en: {
    ...
    "privacy.footer": "For any questions regarding this privacy policy, you may contact Dario Tonini at toninidario@yahoo.fr.",
  },
  ...
  es: {
    ...
    "privacy.footer": "Para cualquier consulta relativa a esta política de privacidad, puede contactar a Dario Tonini en toninidario@yahoo.fr.",
  },
};
