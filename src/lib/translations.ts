...
export const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "privacy.footer": "Pour toute question relative à cette politique de confidentialité, vous pouvez contacter Dario Tonini via la page de contact du site.",
  },
  ...
  en: {
    ...
    "privacy.footer": "For any questions regarding this privacy policy, you may contact Dario Tonini through the contact page on this site.",
  },
  ...
  es: {
    ...
    "privacy.footer": "Para cualquier consulta relativa a esta política de privacidad, puede contactar a Dario Tonini a través de la página de contacto del sitio.",
  },
};
