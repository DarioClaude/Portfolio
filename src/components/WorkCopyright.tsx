...
export default function WorkCopyright() {
  ...
  return (
    <motion.div
      className="flex flex-col items-start justify-between max-w-[200px] md:max-w-[400px]"
    ...
    >
      ...
      <Link
        href="/privacy"
        className="text-[11px] md:text-[13px] font-normal leading-snug tracking-tight text-[#9CA3AF] mt-1 hover:text-[#1A1A1A] transition-colors"
        data-cursor-hover
      >
        {t("work.privacy")}
      </Link>
