...
export function generateMetadata({ params }: Props) {
  ...
  if (!project) return {};
  return { title: `${project.name} — Marlay` };
}
    ...
    <section className="pt-24 pb-20">
      ...
      <div className="px-10 max-w-3xl">
        ...
        <div className="flex gap-4 text-sm text-[#9CA3AF]">
          <span className="border border-[#E5E7EB] px-3 py-1 rounded-full">Branding</span>
          <span className="border border-[#E5E7EB] px-3 py-1 rounded-full">Web Design</span>
          <span className="border border-[#E5E7EB] px-3 py-1 rounded-full">Development</span>
        </div>
      </div>
